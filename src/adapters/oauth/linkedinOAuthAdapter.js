...
class LinkedInOAuthAdapter extends BaseOAuthAdapter {
  buildAuthorizeUrl(state, scopes = ['r_liteprofile', 'r_emailaddress', 'w_member_social']) {
  ...
  async fetchUserProfile(accessToken) {
    const profile = await this.get('https://api.linkedin.com/v2/me', accessToken);
    return {
...
module.exports = LinkedInOAuthAdapter;
