...
const listNotifications = asyncHandler(async (req, res) => { const { page, limit, skip } = parsePagination(req.query);
  ...
  return sendSuccess(res, httpStatus.OK, 'Notifications fetched', result.items, { page,
    limit,
    total: result.total }); });
