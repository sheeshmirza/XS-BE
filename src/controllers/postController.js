...
const listPosts = asyncHandler(async (req, res) => {
  ...
  return sendSuccess(res, httpStatus.OK, 'Posts fetched', result.items, {
    page,
    limit,
    total: result.total
  });
...
const publishPost = asyncHandler(async (req, res) => {
  const post = await postService.publishPost(req.user._id.toString(), req.params.id, req.body.platforms || []);
