...
const socialHandleSchema = new mongoose.Schema(
  { isConnected: { default: true,
      index: true,
      type: Boolean, },
    metadata: { default: {},
      type: mongoose.Schema.Types.Mixed, },
    platform: { enum: ["facebook", "instagram", "linkedin", "x"],
      index: true,
      required: true,
      type: String, },
    platformAccessToken: { required: true,
      type: String, },
    platformAccessTokenExpiry: { default: null,
      index: true,
      type: Date, },
    platformRefreshToken: { default: "",
      type: String, },
    platformScopes: { default: [],
      type: [String], },
    platformUserId: { index: true,
      required: true,
      type: String, },
