...
class SocialHandleRepository {
  ...
  upsertByPlatformIdentity(userId, platform, platformUserId, payload) {
  ...
  updateByIdAndUserId(id, userId, payload) {
    return SocialHandle.findOneAndUpdate({ _id: id, userId }, payload, { new: true });
  }
...
module.exports = new SocialHandleRepository();
